...
def fastq_files(memory="4G", cores=4, disk="5G"):
    ...
    # Not using job.log as it would involve using job function


# Indexing reference fasta file
def index_ref(memory="2G", cores=2, disk="3G"):
...
def align_fastq(memory="2G", cores=2, disk="3G"):
    path = '/home/bioinfo/singularity/variant_analysis'
...
# Sorting bam files
def convrt_sort(memory="2G", cores=2, disk="3G"):
    path = '/home/bioinfo/singularity/variant_analysis'
...
# Variant calling
def variant_call(memory="2G", cores=2, disk="3G"):
    path = '/home/bioinfo/singularity/variant_analysis'
...
def index_fastq(memory="2G", cores=2, disk="3G"):
    path = '/home/bioinfo/singularity/variant_analysis'
...
if __name__=='__main__':
    ...
    j4 = Job.wrapFn(index_ref)
    j5 = Job.wrapFn(align_fastq)
    j6 = Job.wrapFn(convrt_sort)
    j7 = Job.wrapFn(variant_call)
    j8 = Job.wrapFn(index_fastq)
